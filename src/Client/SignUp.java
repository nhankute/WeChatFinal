...
public class SignUp extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        getContentPane().add(nameSign, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 250, 370, 30));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("User Name");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, 160, 30));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Password");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 300, 170, 30));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("MESSAGE - SIGN UP");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 870, 70));

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Repeat password");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 350, 170, -1));
        ...
        getContentPane().add(passSign, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 300, 370, 30));

        repeatPass.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        getContentPane().add(repeatPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 350, 370, 30));
        ...
        getContentPane().add(signUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 430, 140, 40));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/bg_1.png"))); // NOI18N
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 20, 250, 250));

        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 390, 370, 30));
    ...
    private void signUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signUpActionPerformed
        String passText = new String(passSign.getPassword());
        String repeatpass = new String(repeatPass.getPassword());
        if(passText.compareTo(repeatpass)!=0) {
